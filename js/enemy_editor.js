...
const TRAIT_LIBRARY = [
    ...
    { name: "乘胜追击", type: "反应", desc: "当此敌人成功命中玩家角色时，你**获得 1 恐惧点**。" },
    { name: "惊怖", type: "被动", desc: "当此敌人成功攻击时，所有近距离范围内的玩家角色**失去 1 希望点**，而你**获得 1 恐惧点**。" },
    { name: "蓄力", type: "被动", desc: "你必须**花费 1 恐惧点**来聚焦此敌人。当被聚焦时，其可以对范围内所有目标进行普通攻击。" },
    { name: "迟缓", type: "被动", desc: "当你聚焦此敌人，且其数据块上没有指示物时，它无法立即行动。在它的数据块上放置一个标记，并描述它正在准备做什么。当你聚焦此敌人，且其数据块上有指示物时，移除指示物，它才可以行动。" },
    
    { name: "激活盟友", type: "动作", desc: "**花费 X 恐惧点**以聚焦1d4名盟友。以此方式被聚焦期间，他们发动的攻击造成半数伤害。" },
    { name: "呼叫援军", type: "动作", desc: "每场景一次，**标记 1 压力点**以召唤<另一名敌人>，其出现在<指定>范围内。" },
    { name: "战术家", type: "动作", desc: "当你聚焦此敌人时，**标记 1 压力点**可同时聚焦近距离范围内的两名盟友。" },
    ...
    { name: "伺机射击", type: "反应", desc: "当其他敌人在此敌人的远距离范围内对目标造成伤害时，你可**标记 1 压力点**为该伤害掷骰附加<额外伤害>。" },
    { name: "多重打击", type: "反应", desc: "**花费 1 恐惧点**对远距离范围内的#个目标发动攻击。此敌人成功命中的目标受到<削减后伤害>。" },
    ...
    { name: "破甲打击", type: "动作", desc: "当此敌人攻击成功时，目标必须**标记 1 护甲槽**，且不获得其效果（其仍然可以使用护甲来减少伤害）。如果目标无法标记护甲槽，则必须额外**标记 1 生命点**。" },
    ...
    { name: "幽灵形态", type: "被动", desc: "此敌人具有物理伤害抗性。**标记 1 压力点**可穿越固体移动至近距离范围。" },
    { name: "心神扰乱", type: "被动", desc: "玩家角色攻击此敌人时若掷出恐惧结果，需**标记 1 压力点**。" },
